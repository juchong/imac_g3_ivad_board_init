// EEPROM stuff
const byte CONFIG_EEPROM_VERSION        =  0x06;
...
// Slot immediately after the main IVAD config block and the FIRST_RUN sentinel.
// FIRST_RUN occupies CONFIG_EEPROM_SLOTS (20); this occupies CONFIG_EEPROM_SLOTS+1 (21).
const byte AUTO_POWER_ON_EEPROM_SLOT    =  CONFIG_EEPROM_SLOTS + 1;
